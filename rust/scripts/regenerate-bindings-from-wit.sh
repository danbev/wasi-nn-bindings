...
# The revision specified below is the revision that matches the version used
# by wasmtime. This is mainly to ensure that the generated bindings are compatible
# with the example code in this repository.
# TODO (danbev): would it perhaps be better have this a git submodule?
WASI_NN_REVISION=${WASI_NN_REVISION:-e2310b860db2ff1719c9d69816099b87e85fabdb}
